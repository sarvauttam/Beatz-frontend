...
const server = "http://16.170.214.38:7000";
  ...
  return (
    <div className="min-h-screen bg-[#212121] text-white p-8">
        ...
        >
            ...
            <form className="bg-[#181818] p-6 rounded-lg shadow-lg flex flex-col items-center justify-center gap-4" 
            ...
            <div className="mt-8">
                ...
                <div className="flex justify-center md:justify-start gap-2 items-center flex-wrap">
                    {
                        albums?.map((e,i) => {
                            return <div className="bg-[#181818] p-4 rounded-lg shadow-md"
                            key={i}>
                                <img src={e.thumbnail} className="mr-1 w-52 h-52" alt="" />
                                <h4 className="text-lg font-bold">{e.title.slice(0, 30)}</h4>
                                <h4 className="text-lg font-bold">{e.description.slice(0, 20)}..
                                </h4>
                                <button 
                                disabled={btnLoading}
